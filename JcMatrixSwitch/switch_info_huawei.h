...
"namelist			=Signalswich,Paspecumpwmt,Testmdlte700,Testmddd800,Testmdgsm900,Testmddcs1800,Testmdpcs1900,Testmdwcdma2100,Testmdlte2600,Testmddpc1500\n"\
...
"\n"\
"Gpp1500Atx1     = Signal1swich(Signalswich,PA4in1) , Txoutswich(Testmddpc1500 ,nc1)\n"\
"\n"\
"Gpp1500Btx1     = Signal1swich(Signalswich,PA4in1) , Txoutswich(Testmddpc1500 ,no2)\n"\
"[actiontx2]\n"\
"\n"\
...
"\n"\
"Gpp1500Atx2     = Signal2swich(Signalswich,PA4in2) , Txoutswich(Testmddpc1500 ,nc1)\n"\
"\n"\
"Gpp1500Btx2    = Signal2swich(Signalswich,PA4in2) , Txoutswich(Testmddpc1500 ,no2)\n"\
"\n"\
"\n"\
"\n"\
"[actionpim]\n"\
...
"\n"\
"Gpp1500Apim 	= Spectrumswich(Paspecumpwmt,MD1500pim),Pimswich(Testmddpc1500, nc1)\n"\
"\n"\
"Gpp1500Bpim 	= Spectrumswich(Paspecumpwmt,MD1500pim),Pimswich(Testmddpc1500, no2)\n"\
"\n"\
"[actiondet]\n"\
...
"\n"\
"Gpp1500tx1det = Powermeterswich(Paspecumpwmt,MD1500ppwmt), Couplerswich(Testmddpc1500,nc1)\n"\
"\n"\
"Gpp1500tx2det = Powermeterswich(Paspecumpwmt,MD1500ppwmt), Couplerswich(Testmddpc1500,no2)\n"\
""
